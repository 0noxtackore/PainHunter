...
export default function WelcomeScreen({ onPick }) {
  return (
    <div className="flex min-h-full flex-col items-center justify-center px-6 py-6 text-center">
      ...
      <h2 className="mt-5 text-xl font-semibold text-slate-900">Hola, soy Mr Hunter</h2>
      <p className="mt-2 max-w-md text-sm leading-relaxed text-slate-500">
        Estoy aquí para escucharte sobre tus problemas laborales, el cansancio, las pérdidas o las
        dificultades con otras personas. Nada de lo que compartas es juzgado. ¿Qué te está pasando hoy?
      </p>
