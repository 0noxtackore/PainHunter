...
export const TROPHIES = [
  ...
  { id: 'first-pain', name: 'Primer obstáculo', description: 'Registra tu primera observación de trabajo.', icon: '🩹' },
  { id: 'pain-noted', name: 'Vigilante de procesos', description: 'Registra 10 observaciones de trabajo.', icon: '📋' },
