...
export const TROPHIES = [
  ...
  { id: 'first-pain', name: 'Primer obstáculo', description: 'Gana puntos al compartir tu primer obstáculo de trabajo.', icon: '🩹' },
  { id: 'pain-noted', name: 'Vigilante de procesos', description: 'Gana puntos al compartir 10 obstáculos de trabajo.', icon: '📋' },
